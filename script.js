...
const prompts = {
  ...
  19: "A hyper-realistic cinematic editorial portrait of the uploaded person (preserve face 100%). HE stands tall in a dark MAROON moody studio,surrounded by soft drifting black white smoke under a dramatic spotlight.Outfit:Fit white luxury suit with fit-leg trousers, paired with a slightly unbuttoned white silk shirt. Both hands tucked casually in pockets, shoulders relaxed, confident expression, head tilted slightly upward"  
};
